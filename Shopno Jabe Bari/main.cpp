...
bool scenarioHazary = true;
bool scenarioMowmita = false;
bool scenarioNeloy = false;
bool scenarioPritom = false;
...
void keyboard(unsigned char key, int x, int y)
{
    ...
    if (key == ' ')
    {
        ...
        if(V_busPaused)
        {
            V_savedBusSpeed = V_busPaused;
            V_busPaused = 0;
        }
        else
        {
            V_busPaused = V_savedBusSpeed;
        }
    ...
    if(key == 'm' || key == 'M')
    {
        scenarioHazary = false;
        scenarioNeloy = true;
        scenarioPritom = false;
        scenarioMowmita = false;
    }
    if(key == 'a' || key == 'A')
    {
        scenarioHazary = false;
...
void mouse(int button, int state, int x, int y)
{
    if (state == GLUT_DOWN)
    {
        if (isDay)
        {
            if (button == GLUT_LEFT_BUTTON)  // Pause/resume Train (Day)
            {
                trainPaused = !trainPaused;
                if (trainPaused)
                {
            ...
            else if (button == GLUT_RIGHT_BUTTON)  // Pause/resume Sun (Day)
            {
                sunPaused = !sunPaused;
                if (sunPaused)
                {
        ...
        {
            if (button == GLUT_LEFT_BUTTON)  // Pause/resume Moon (Night)
            {
                moonPaused = !moonPaused;
                if (moonPaused)
                {
            ...
            else if (button == GLUT_RIGHT_BUTTON)  // Pause/resume Cargo (Night)
            {
                V_cargoPaused = !V_cargoPaused;
                if (V_cargoPaused)
                {
...
void specialKeysM(int key, int x, int y)
{
    ...
    else  // If it's night
    {
        ...
        {
        case GLUT_KEY_UP:
            car1_nightMSpeed += 0.6f;
            break;

        case GLUT_KEY_DOWN:
            car1_nightMSpeed -= 0.6f;
            if (car1_nightMSpeed < 0) car1_nightMSpeed = 0;
            break;
        }
    }
}
...
void display()
{
    if(scenarioHazary) hazary();
    if(scenarioNeloy) Neloy();
    if(scenarioPritom) pritom();
    if(scenarioMowmita) mowmita();
...
int main(int argc, char** argv)
{
    ...
    cout << "Press key_up and key_down to speed up or down the train in day mode" << endl;
    cout << "Press key_right and key_left to speed up or down the moon in night mode" << endl;
    cout << "Press spacebar to pause or resume everything in day or night mode" << endl;
    cout << "Press mouse_left_button to play or pause the train in day mode" << endl;
    cout << "Press mouse_right_button to play or pause the sun in day mode" << endl;
    cout << "Press mouse_left_button to play or pause the moon in night mode" << endl;
    cout << "Press mouse_right_button to play or pause the cargo in night mode" << endl;
    cout << "Press ESC to exit the program" << endl;

    cout<<"********** >>>Sub City Functionality<<< **********"<<endl;
    cout << "Press spacebar to pause or resume everything in day or night mode" << endl;
    cout << "Press key_up and key_down to speed up or down the track in day or night mode" << endl;
    cout << "Press key_right and key_left to speed up or down the cloud in night mode" << endl;
    cout << "Press mouse_left_button to play or pause the bus in day or night mode" << endl;
    cout << "Press ESC to exit the program" << endl;

    cout<<"********** >>>Bridge Functionality<<< **********"<<endl;
    cout << "Press key_up and key_down to speed up or down car1 in day or night mode" << endl;
    cout << "Press key_right to increase ambulance speed in day mode" << endl;
    cout << "Press key_left to decrease or reverse ambulance speed in day mode" << endl;
    cout << "Press mouse_left_button to play or pause car1 in day mode" << endl;
    cout << "Press mouse_right_button to play or pause the train in night mode" << endl;
    cout << "Press ESC to exit the program" << endl;

    cout<<"********** >>>Village Functionality<<< **********"<<endl;
    cout << "Press mouse_left_button to play or pause the sun in day mode" << endl;
    cout << "Press mouse_right_button to play or pause car1 in day mode" << endl;
    cout << "Press spacebar to pause or resume everything in day or night mode" << endl;
    cout << "Press key_up and key_down to speed up or down car1 in day mode" << endl;
    cout << "Press key_right and key_left to speed up or down car2 in night mode" << endl;
    cout << "Press ESC to exit the program" << endl;
    ...
    glutCreateWindow("Sopno Jabe Bari");
